...
public class DeliveryChallanDetailsList {
    ...
    public DeliveryChallanDetailsList(String sm_id, String sd_id, String item_name, String part_no, String item_amnt, String item_qty, String item_id, ArrayList<DCColorWiseItemList> dcColorWiseItemLists) {
        this.sm_id = sm_id;
        this.sd_id = sd_id;
