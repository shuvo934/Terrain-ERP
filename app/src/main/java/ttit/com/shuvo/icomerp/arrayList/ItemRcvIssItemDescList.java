...
public class ItemRcvIssItemDescList {
    ...
    public ItemRcvIssItemDescList(String itemId, String itemName, String unit, String catName, String subCatName, ArrayList<ItemRcvIssWarehouseList> itemRcvIssWarehouseLists) {
        this.itemId = itemId;
