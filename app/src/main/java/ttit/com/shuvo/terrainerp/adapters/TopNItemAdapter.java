...
public class TopNItemAdapter extends RecyclerView.Adapter<TopNItemAdapter.TopNItemHolder> {
    ...
    private ArrayList<TopNItemLists> mCategoryItem;
    private final ClickedItem myClickedItem;
    private final Context myContext;

    int selectedPosition = -1;

    public TopNItemAdapter(ArrayList<TopNItemLists> mCategoryItem, Context myContext, ClickedItem myClickedItem) {
    ...
    public void onBindViewHolder(@NonNull TopNItemHolder holder, int position) {
        ...
        TopNItemLists topNItemLists = mCategoryItem.get(position);
    ...
    public void filterList(ArrayList<TopNItemLists> filteredList) {
