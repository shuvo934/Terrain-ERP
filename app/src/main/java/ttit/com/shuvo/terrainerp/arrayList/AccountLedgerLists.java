...
public class AccountLedgerLists {
    ...
    public AccountLedgerLists(String lgId, String date, String voucherNo, String particulars, String lgDebit, String debit, String lgCredit, String credit, String openingDebit, String openingCredit, String ahCode, String balance, boolean updated) {
        this.lgId = lgId;
        this.date = date;
