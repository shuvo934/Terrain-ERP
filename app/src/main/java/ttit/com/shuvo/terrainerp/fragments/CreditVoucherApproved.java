...
import ttit.com.shuvo.terrainerp.adapters.CreditVoucherApprovedAdapter;
 ...
 * Use the {@link CreditVoucherApproved#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CreditVoucherApproved extends Fragment implements CreditVoucherApprovedAdapter.ClickedItem {
...
//    private Connection connection;
    ...
    public static TextInputEditText creditVoucherSelectSpinner;

    public static String cVm_id = "";

    public static int fromCVA = 0;

    public static String status_approved_CV = "";

    public static String appDisUser_CV = "";
    public static String appDisTime_CV = "";
    ...
    ArrayList<CreditVoucherApprovedLists> creditVoucherApprovedLists;

    double total_debit = 0.0;
    double total_credit = 0.0;
    String approve_flag = "";

    public CreditVoucherApproved() {
     ...
     * @return A new instance of fragment CreditVoucherApproved.
     */
    // TODO: Rename and change types and number of parameters
    public static CreditVoucherApproved newInstance(String param1, String param2) {
        CreditVoucherApproved fragment = new CreditVoucherApproved();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_credit_voucher_approved, container, false);

        creditVoucherSelectSpinner = view.findViewById(R.id.credit_voucher_search_text);
        afterVoucherSelect = view.findViewById(R.id.credit_voucher_approved_details_card);
        afterVoucherSelect.setVisibility(View.GONE);

        vDate = view.findViewById(R.id.date_credit_approved);
        vTime = view.findViewById(R.id.time_credit_approved);
        preparedBy = view.findViewById(R.id.prepared_by_credit_approved);
        billRefNo = view.findViewById(R.id.bill_ref_no_credit_approved);
        billRefDate = view.findViewById(R.id.bill_ref_date_credit_approved);
        narration = view.findViewById(R.id.narration_credit_approved);
        statusReview = view.findViewById(R.id.status_credit_approved);
        appOrDisAppUser = view.findViewById(R.id.app_or_disapp_credit_approved);
        appOrDisAppUserLay = view.findViewById(R.id.app_or_disapp_credit_approved_layout);
        appOrDisAppTime = view.findViewById(R.id.app_or_disapp_time_credit_approved);
        appOrDisAppTimeLay = view.findViewById(R.id.app_or_disapp_time_credit_approved_layout);

        totalDebit = view.findViewById(R.id.total_debit_cva);
        totalCredit = view.findViewById(R.id.total_credit_cva);

        approve = view.findViewById(R.id.approve_button_cva);
        reject = view.findViewById(R.id.reject_button_cva);

        itemView = view.findViewById(R.id.credit_voucher_approved_transaction_view);
        ...
        creditVoucherApprovedLists = new ArrayList<>();


        creditVoucherSelectSpinner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fromCVA = 1;
                VoucherSelectionDial voucherSelectionDial = new VoucherSelectionDial(mContext);
                voucherSelectionDial.show(getActivity().getSupportFragmentManager(),"CVS");
            }
        });

        creditVoucherSelectSpinner.addTextChangedListener(new TextWatcher() {
            @Override
...
//                    System.out.println(status_approved_CV);
...
//
//
//                creditVoucherApprovedAdapter = new CreditVoucherApprovedAdapter(creditVoucherApprovedLists,getContext(),CreditVoucherApproved.this);
//                itemView.setAdapter(creditVoucherApprovedAdapter);
//
//                if (creditVoucherApprovedLists.size() != 0) {
//                    vDate.setText(creditVoucherApprovedLists.get(0).getVmDate());
//                    vTime.setText(creditVoucherApprovedLists.get(0).getVmTime());
//                    preparedBy.setText(creditVoucherApprovedLists.get(0).getVmUser());
//                    billRefNo.setText(creditVoucherApprovedLists.get(0).getVmBillRefNo());
//                    billRefDate.setText(creditVoucherApprovedLists.get(0).getVmBillRefDate());
//                    narration.setText(creditVoucherApprovedLists.get(0).getVmNarration());
//                } else {
//                    vDate.setText("");
//                    vTime.setText("");
//                    preparedBy.setText("");
...
//                afterVoucherSelect.setVisibility(View.GONE);
//                cVm_id = "";
//                creditVoucherSelectSpinner.setText("");
//
//
//
//
...
//            callableStatement1.setInt(2,Integer.parseInt(cVm_id));
...
//                creditVoucherApprovedLists.add(new CreditVoucherApprovedLists(resultSet.getString(1),resultSet.getString(2),resultSet.getString(3),
...
//
//            if (creditVoucherApprovedLists.size() != 0) {
//                for (int i = 0; i < creditVoucherApprovedLists.size() ; i++) {
//                    if (creditVoucherApprovedLists.get(i).getVdDebit() != null) {
//                        total_debit = total_debit + Double.parseDouble(creditVoucherApprovedLists.get(i).getVdDebit());
//                    }
//                    if (creditVoucherApprovedLists.get(i).getVdCredit() != null) {
//                        total_credit = total_credit + Double.parseDouble(creditVoucherApprovedLists.get(i).getVdCredit());
//                    }
//                }
//            }
//
...
//    }
    ...
    public void getAccData() {
        ...
        String url = "http://103.56.208.123:8001/apex/tterp/voucherApprove/getVoucherList/"+cVm_id+"";
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, response -> {
            ...
            try {
                ...
                if (!count.equals("0")) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        for (int j = 0; j < voucherArray.length(); j++) {
                            ...
                            creditVoucherApprovedLists.add(new CreditVoucherApprovedLists(vm_id,vm_no,vm_date,
                ...
                if (creditVoucherApprovedLists.size() != 0) {
                    for (int i = 0; i < creditVoucherApprovedLists.size() ; i++) {
                        if (creditVoucherApprovedLists.get(i).getVdDebit() != null) {
                            if (!creditVoucherApprovedLists.get(i).getVdDebit().isEmpty()) {
                                total_debit = total_debit + Double.parseDouble(creditVoucherApprovedLists.get(i).getVdDebit());
                            }
                        }
                        if (creditVoucherApprovedLists.get(i).getVdCredit() != null) {
                            if (!creditVoucherApprovedLists.get(i).getVdCredit().isEmpty()) {
                                total_credit = total_credit + Double.parseDouble(creditVoucherApprovedLists.get(i).getVdCredit());
                            }
                        }
                    }
...
//            callableStatement1.setInt(1,Integer.parseInt(cVm_id));
    ...
    private void updateLayout() {
        ...
        if (conn) {
            if (connected) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(mContext)
                        .setMessage("Failed to update Credit Voucher. Please Try Again.")
                        .setPositiveButton("Retry", null)
                        .setNegativeButton("Cancel", null)
                        .show();
